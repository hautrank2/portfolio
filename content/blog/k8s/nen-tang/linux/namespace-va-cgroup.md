...
> Xem [ghi chú môi trường](/blog/k8s/nen-tang/linux) nếu chưa dựng lab.
...
[Process, PID 1 và signal](/blog/k8s/nen-tang/linux/process-va-signal) sẽ khai thác:
...
ở [note tiếp theo](/blog/k8s/nen-tang/linux/process-va-signal) hết trừu tượng.
