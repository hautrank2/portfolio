...
`namespaces` — bài [unshare](/blog/k8s/nen-tang/linux/namespace-va-cgroup).
...
Chuỗi đầy đủ nằm ở [bài containerd–CRI–runc](/blog/k8s/nen-tang/container/containerd-cri-runc).
