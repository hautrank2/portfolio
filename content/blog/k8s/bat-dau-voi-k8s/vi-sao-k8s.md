...
[Note trước](/blog/k8s/bat-dau-voi-k8s/van-de-deploy-thu-cong) kết thúc bằng một danh
...
tế về phía nó. Chi tiết vòng lặp nằm ở note [Cluster là gì](/blog/k8s/bat-dau-voi-k8s/cluster-la-gi).
...
[bài sau](/blog/k8s/bat-dau-voi-k8s/k8s-khong-quan-ly-ha-tang) sẽ nói bằng chữ in hoa.

## Tự kiểm

- [ ] Ứng được mỗi vấn đề ở [Vấn đề của deploy thủ công](/blog/k8s/bat-dau-voi-k8s/van-de-deploy-thu-cong)
