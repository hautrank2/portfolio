...
[nen-tang/linux](/blog/k8s/nen-tang/linux/namespace-va-cgroup) là cơ chế cách ly của
...
[Index của section](/blog/k8s/bat-dau-voi-k8s) đặt ra một câu:
...
vòng lặp reconcile ở [Cluster là gì](/blog/k8s/bat-dau-voi-k8s/cluster-la-gi), nhìn từ
hướng ngược lại.
