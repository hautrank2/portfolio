...
[Note 6.1](/blog/k8s/data-and-volumes/starting-project) vừa dạy bạn một trực giác rất
...
K8s mount được volume vào container, nhưng kèm theo đúng hai điều:

| Điều đi kèm | Cụ thể là gì |
| --- | --- |
| **Rất nhiều kiểu / driver được hỗ trợ** | Volume **"local"** — một thư mục nằm trên node; hoặc volume **của nhà cung cấp cloud** — đĩa EBS, GCE disk… |
| **Vòng đời volume bám theo vòng đời Pod** | Sống qua container restart, kể cả khi container bị **xoá** — nhưng **mất khi Pod bị huỷ** |

Hàng đầu là điều tốt: bạn chọn được chỗ chứa hợp với nhu cầu, thay vì bị ép dùng một
kiểu duy nhất.

Hàng sau là điều phải nhớ kỹ: **volume gắn với Pod, không gắn với container.** Nó sống
...
[note 5.10](/blog/k8s/k8s-in-action/container-restarts): container chết là kubelet dựng
