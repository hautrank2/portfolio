...
xem [Nhìn kỹ vào Worker Node](/blog/k8s/getting-started/worker-node). Không đọc HTTP,
không biết path.
...
[DNS và resolv.conf](/blog/k8s/foundations/networking/dns-and-resolv-conf) thì đây đúng là cơ chế
