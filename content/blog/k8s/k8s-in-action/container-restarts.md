...
> **Cần làm xong [note 5.9](/blog/k8s/k8s-in-action/exposing-a-deployment-with-a-service)
...
Cùng ý đó ở tầng Linux: [process và signal](/blog/k8s/foundations/linux/processes-and-signals).
