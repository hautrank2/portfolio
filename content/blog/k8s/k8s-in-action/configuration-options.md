...
[Container restart lúc nào](/blog/k8s/k8s-in-action/container-restarts).
...
[Scaling trong thực tế](/blog/k8s/k8s-in-action/scaling), nhưng lấy được nhiều trường
hơn.
...
[Cập nhật Deployment](/blog/k8s/k8s-in-action/updating-deployments).
