...
> thường — xem [ghi chú môi trường](/blog/k8s/foundations/linux) nếu chưa.
...
1. **`nameserver 10.43.0.10`** — không phải DNS của VM! Đây là Service
   `kube-dns` (bạn đã thấy IP này ở [bài CIDR](/blog/k8s/foundations/networking/ip-subnet-cidr)).
