...
sẽ có [nguyên một module riêng](/blog/k8s/du-lieu-va-volume); ở đây chỉ cần nhớ: tài
...
[Service](/blog/k8s/k8s-thuc-chien/service-object), chuyện của vài note sau.
...
[namespace](/blog/k8s/nen-tang/linux/namespace-va-cgroup).
...
một địa chỉ ổn định trước đám Pod phù du chính là [Service](/blog/k8s/k8s-thuc-chien/service-object).
...
[Object Deployment](/blog/k8s/k8s-thuc-chien/deployment-object), note ngay sau.
