...
[note khởi động lại container](/blog/k8s/k8s-thuc-chien/restart-container) lẫn
[liveness probe](/blog/k8s/k8s-thuc-chien/liveness-probe). Cả module có một app, và app
...
[không quản lý hạ tầng](/blog/k8s/k8s-thuc-chien/k8s-khong-quan-ly-ha-tang-2) — nó chỉ
...
ngay phải đi hỏi ai — [note sau](/blog/k8s/k8s-thuc-chien/kubectl-phia-sau-hau-truong)
vẽ đủ bốn chặng.
