...
`port-forward` ở [note 5.6](/blog/k8s/k8s-thuc-chien/deployment-dau-tien-imperative) là
một ống nối tạm, chết theo phiên terminal. Còn `first-app` ở
[note 5.8](/blog/k8s/k8s-thuc-chien/service-object) mới chỉ có ClusterIP — gọi được từ
...
thấy nhau. [Note 5.6](/blog/k8s/k8s-thuc-chien/deployment-dau-tien-imperative) đào kỹ
chuyện này.
...
[K8s không quản lý hạ tầng](/blog/k8s/k8s-thuc-chien/k8s-khong-quan-ly-ha-tang-2) lặp lại
...
[note về label](/blog/k8s/k8s-thuc-chien/label-va-selector).
