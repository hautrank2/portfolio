...
> **Nối tiếp [note 5.14](/blog/k8s/k8s-thuc-chien/imperative-vs-declarative).** Từ đây tới
...
[note 5.13](/blog/k8s/k8s-thuc-chien/rollback-va-lich-su): image `:1` bạn `ctr import` vào
...
[note 5.9](/blog/k8s/k8s-thuc-chien/phoi-deployment-bang-service): chỗ đó K8s **không**
...
Giữ Pod này lại, đừng xoá — [note 5.18](/blog/k8s/k8s-thuc-chien/viet-file-service) sẽ
