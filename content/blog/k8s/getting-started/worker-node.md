...
trông coi — xem [systemd cơ bản](/blog/k8s/foundations/linux/systemd-basics).
...
Chuỗi đầy đủ, đã dựng ở [containerd, CRI và runc](/blog/k8s/foundations/container/containerd-cri-runc):
