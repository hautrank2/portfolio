...
[Cluster là gì](/blog/k8s/getting-started/what-is-a-cluster) đã dựng bức tranh máy móc:
...
Nếu bạn đã đọc [namespace và cgroup](/blog/k8s/foundations/linux/namespaces-and-cgroups),
...
Ingress. Đúng ranh giới đã dựng ở [L4 và L7](/blog/k8s/foundations/networking/l4-vs-l7) và
[reverse proxy](/blog/k8s/foundations/networking/reverse-proxy).
