...
đúng thứ đã nói ở
[Kubernetes KHÔNG quản lý hạ tầng của bạn](/blog/k8s/getting-started/k8s-does-not-manage-infrastructure).
...
[Cluster là gì](/blog/k8s/getting-started/what-is-a-cluster) để ngỏ câu hỏi vì sao node
...
[Vì sao Kubernetes?](/blog/k8s/getting-started/why-kubernetes) nói. Xem tận nơi:
