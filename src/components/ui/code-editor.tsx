...
function CodeEditor({
  ...
  // Only the typewriter needs state; when `writing` is off the full source
  // is already a prop, so deriving it avoids a render just to copy it over.
  const visibleCode = writing ? typedCode : code
