...
export const experienceData: ExperienceModel[] = [
  ...
  },
  {
    ...
    des: "I studied IT here with a major in Software Engineering. During my 4 years, I had some activities at the media group and received the Prize for Student of 5 merits.",
    photos: [
      {
